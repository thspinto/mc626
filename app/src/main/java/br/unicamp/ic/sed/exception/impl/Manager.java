...
class Manager implements br.unicamp.ic.sed.exception.prov.IManager{
	...
	Manager() {
		this.setProvidedInterface("IException", new IExceptionFacade(this));
		this.setProvidedInterface("IManager", this);
		this.setProvidedInterfaceTypes("IException", br.unicamp.ic.sed.exception.impl.IExceptionFacade.class);
		this.setProvidedInterfaceTypes("IManager", br.unicamp.ic.sed.exception.prov.IManager.class);
	}
