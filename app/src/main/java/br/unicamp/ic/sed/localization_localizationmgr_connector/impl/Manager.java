...
class Manager implements br.unicamp.ic.sed.localization_localizationmgr_connector.impl.IManager{
private Hashtable providedIterfaces = new Hashtable();
	...
	Manager() {
		this.setProvidedInterface("ILocalizationLoader", new Adapter(this) );
		this.setProvidedInterfaceTypes("IManager", br.unicamp.ic.sed.localization_localizationmgr_connector.impl.IManager.class);
	}
