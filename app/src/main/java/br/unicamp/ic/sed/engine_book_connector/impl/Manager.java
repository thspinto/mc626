...
class Manager implements br.unicamp.ic.sed.engine_book_connector.impl.IManager{
	...
	Manager() {
		this.setProvidedInterface("IBook", new Adapter(this));
		this.setProvidedInterfaceTypes("IManager", br.unicamp.ic.sed.engine_book_connector.impl.IManager.class);
	}
