...
private Hashtable providedIterfaces = new Hashtable();
	...
	Manager() {
		this.setProvidedInterface("IGUIInterface", new Adapter(this));
		this.setProvidedInterface("IManager", this);
		this.setProvidedInterfaceTypes("IManager", br.unicamp.ic.sed.exception_gui_connector.IManager.class);
	}
