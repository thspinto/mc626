...
class Manager implements br.unicamp.ic.sed.persistancemgr.prov.IManager{
private Hashtable providedIterfaces = new Hashtable();
	...
	Manager() {
		this.setProvidedInterface("IPersistance", new IPersistanceFacade());
		this.setProvidedInterface("IManager", this);
		this.setProvidedInterfaceTypes("IPersistance", br.unicamp.ic.sed.persistancemgr.prov.IPersistance.class);
		this.setProvidedInterfaceTypes("IManager", br.unicamp.ic.sed.persistancemgr.prov.IManager.class);
	}
