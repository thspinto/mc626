...
class Manager implements IManager{
	...
	Manager() {
		this.setProvidedInterface("IHistory", new Adapter(this));
		this.setProvidedInterfaceTypes("IManager", br.unicamp.ic.sed.engine_history_connector.impl.IManager.class);
	}
