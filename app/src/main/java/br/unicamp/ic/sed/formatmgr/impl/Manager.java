...
class Manager implements br.unicamp.ic.sed.formatmgr.prov.IManager{
	...
	Manager() {
		this.setProvidedInterface("IFormat", new IFormatFacade());
		this.setProvidedInterface("IManager", this);
		this.setProvidedInterfaceTypes("IFormat", br.unicamp.ic.sed.formatmgr.prov.IFormat.class);
		this.setProvidedInterfaceTypes("IManager", br.unicamp.ic.sed.formatmgr.prov.IManager.class);
	}
