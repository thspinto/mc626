...
private Hashtable providedIterfaces = new Hashtable();
	...
	Manager() {
		this.setProvidedInterface("IFormat", new Adapter(this));
		this.setProvidedInterfaceTypes("IManager", br.unicamp.ic.sed.engine_format_connector.impl.IManager.class);
	}
