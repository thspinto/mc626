...
class Manager implements br.unicamp.ic.sed.engine.prov.IManager{
	...
	Manager() {
		this.setProvidedInterface("IEngine", new IEngineFacade(this));
		this.setProvidedInterface("IManager", this);
		this.setProvidedInterfaceTypes("IEngine", br.unicamp.ic.sed.engine.prov.IEngine.class);
		this.setProvidedInterfaceTypes("IManager", br.unicamp.ic.sed.engine.prov.IManager.class);
	}
