...
class Manager implements br.unicamp.ic.sed.historymgr.prov.IManager {
	...
	Manager() {
		this.setProvidedInterface("IHistory", new IHistoryFacade());
		this.setProvidedInterface("IManager", this);
		this.setProvidedInterfaceTypes("IHistory", br.unicamp.ic.sed.historymgr.prov.IHistory.class);
		this.setProvidedInterfaceTypes("IManager", br.unicamp.ic.sed.historymgr.prov.IManager.class);
	}
